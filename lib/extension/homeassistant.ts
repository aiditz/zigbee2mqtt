    ...
    private exposeToConfig(exposes: zhc.DefinitionExpose[], entityType: 'device' | 'group',
        ...
        if (firstExpose.type === 'light') {
            ...
            const lookup: {[s: string]: KeyValue} = {
                ...
                illuminance: {
                    device_class: 'illuminance', enabled_by_default: false,
                },
                soil_moisture: {icon: 'mdi:water-percent'},
                position: {icon: 'mdi:valve'},
                pressure: {device_class: 'pressure'},
                power: {device_class: 'power'},
                linkquality: {enabled_by_default: false, icon: 'mdi:signal'},
                current: {device_class: 'current'},
                voltage: {device_class: 'voltage', enabled_by_default: false},
                current_phase_b: {device_class: 'current'},
                voltage_phase_b: {
                    device_class: 'voltage', enabled_by_default: false,
                },
                ...
                eco2: {device_class: 'carbon_dioxide'},
